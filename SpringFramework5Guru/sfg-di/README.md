...
1. Dependency Injection without spring - all three - properties, setter & constructor
2. Dependency Injection with spring - all three - properties, setter & constructor
3. Qualifiers in spring
...
Once the application has started, the output can be seen in the logs.
