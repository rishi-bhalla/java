...
/**
 * This class is responsible for reading the source and the file to be embedded and performing the actual embedding of the data/file into the image.
 * Before embedding, it encrypts the data to provide an additional layer of security.
 */
public class Embedder {
    ...
    /**
     * This method contains the steps/algorithm to do the actual embedding of the data/file inside the image.
     *
     * @throws Exception
     */
    public void embed() throws Exception {
        ...
        //2. retrieve the pixel matrix of the image
        WritableRaster raster = vessel.getRaster();

        //3. open the file to embed to reading
